...
const { isArray } = Array;
const isNeedingDerivationsCheck = (format: string) => format === 'p2tr';
const isTrSupported = (n: { address_type: string }[]) => !!n.find(n => n.address_type === 'TAPROOT_PUBKEY');
 ...
 * @param {Object} createNewAddrParams; {@link CreateNewAddrParams}
    ...
    return new Promise((resolve, reject) => {
        return auto({
            ...
            validate: cbk => {
                ...
                if (!isTapd({ method, type, tapd: args.tapd })) {
